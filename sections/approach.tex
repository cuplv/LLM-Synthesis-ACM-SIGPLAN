...
These fixes ensure that subsequent predictions are conditioned on the correct context, mimicking a scenario in which constrained decoding or symbolic repair techniques guide the LLM to feasible search paths.
...
\end{tabular}
\caption{This table presents the results after evaluating the number of table and column schema errors where the gold lexeme appears in the top-k predictions, as well as the number of times it was the highest-ranked valid schema element.}
...
\midrule
\textbf{Total Operator Errors} & 676 & 163 & 126\\
\quad Where and Having Errors & 147 & 53 & 47\\
\quad Other Operator Errors & 529 & 110 & 79\\
\midrule
\textbf{Schema Table and Column Errors} & 352 & 498 & 521\\
\textbf{Aggregate Function Errors} & 111 & 111 & 105\\
\textbf{Alias Errors} & 21 & 27 & 415\\
\textbf{Other / Unclassified} & 102 & 60 & 80\\
\bottomrule
...
\midrule
\textbf{Total Operator Errors} & 0.07 & 0.53 & 0.53\\
\quad Where and Having Errors & 0.01 & 0.4 & 0.45\\
\quad Other Operator Errors & 0.09 & 0.6 & 0.58\\
\midrule
...
\textbf{Other / Unclassified} & 0.68 & 0.53 & 0.29\\
\bottomrule
\textbf{Total Errors} & 0.53 & 0.80 & 0.79\\
\end{tabular}
\caption{This table presents the percentage of the gold lexeme found in the top-k by category. Where k=10.}
\label{tab:top_k}
\end{table*}
